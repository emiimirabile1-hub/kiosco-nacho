function generarDatosPrueba() {
  ...
  // Guardar productos y mapear IDs
  let idsCreados = [];
  productosBase.forEach(p => {
    ...
    if (existente) {
      ...
      const nuevo = { ...p, id: undefined, codigoBarra: '', stockMinimo: p.stockMinimo };
  ...
  for (let d = 29; d >= 0; d--) {
    ...
    if (d > 0 && Math.random() < 0.15) continue; // algunos días sin ventas
  ...
  alert('✅ Datos de prueba generados:\n' +
    ...
    '• ~30 días de ventas y compras simuladas\n' +
    '• Caja abierta con $5,000 iniciales\n\n' +
